...
--
-- Host: localhost    Database: cs452project
-- ------------------------------------------------------
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `vocab` (
  `vocabID` int NOT NULL AUTO_INCREMENT,
  `userID` int NOT NULL,
  `value` varchar(100) NOT NULL,
  `english_value` varchar(100) NOT NULL,
  `description` varchar(100) NOT NULL,
  `prev_reviewed` date DEFAULT NULL,
  `cur_reviewed` date DEFAULT NULL,
...
-- Dump completed on 2020-10-15 14:48:44
